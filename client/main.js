...
const updateCharacter = (id, type) => axios.put(`${baseURL}/${id}`, {type}).then(characterCallback).catch(errCallback)
...
function createCharacterCard(character) {
    ...
    <div class="btns-container">
        <button onclick="updateCharacter(${character.id}, 'minus')">-</button>
        <p class="stat-card"> STR = ${character.statStrength}</p>
        <button onclick="updateCharacter(${character.id}, 'plus')">+</button>
    </div>
    <div class="btns-container">
        <button onclick="updateCharacter(${character.id}, 'minus')">-</button>
